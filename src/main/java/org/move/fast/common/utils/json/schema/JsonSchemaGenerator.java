...
public interface JsonSchemaGenerator {
     ...
     * @throws Exception 异常
     */
    String fromString(String string) throws Exception;
     ...
     * @throws Exception 异常
     */
    String fromFile(File file) throws Exception;
     ...
     * @throws Exception 异常
     */
    String fromReader(Reader reader) throws Exception;
     ...
     * @throws Exception 异常
     */
    String fromUrl(URL url) throws Exception;
